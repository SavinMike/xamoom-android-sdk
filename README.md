...
* Check out the [documentation](https://xamoom.github.io/xamoom-android-sdk/3.0.0/) (not up to date)
...
Here you can find the full java   [documentation](https://xamoom.github.io/xamoom-android-sdk/3.0.0/).
